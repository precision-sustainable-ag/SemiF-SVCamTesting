...
def parse_arguments():
    ...
    parser.add_argument("--brightness", type=float, default=1.3, help="Brightness adjustment factor (default: 1.3) Change to your preference, e.g., 1.2–1.5")
...
def adjust_brightness(img, factor):
    ...
    Handles both uint8 and uint16 images.
    """
...
def main():
    ...
    for raw_path in selected:
        ...
        if output_path.exists():
            ...
            full_img = adjust_brightness(full_img, brightness_factor)
